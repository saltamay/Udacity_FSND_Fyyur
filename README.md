Udacity Full Stack NanoDegree Project #1 - FYYUR
-----
...
1. [Main Files: Project Structure](#main-files-project-structure)
1. [Stand Out](#stand-out)
1. [Development Setup](#development-setup)

### Overview

This app was nearly complete. It was only missing one thing… real data! While the views and controllers were defined in this application, it was missing models and model interactions to be able to store retrieve, and update data from a database. 

As a full stack engineer, I built out the data models to power the API endpoints for the site by connecting to a PostgreSQL database for storing, querying,and creating information about artists and venues on Fyyur.

By the end of the project, the Fyyur site was fully functioning, that is, it was capable of doing the following, using a PostgreSQL database:
...
* **HTML**, **CSS**, and **Javascript** with [Bootstrap 3](https://getbootstrap.com/docs/3.4/customize/) Frontend Technologies
